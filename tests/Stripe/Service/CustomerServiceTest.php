...
class CustomerServiceTest extends \Stripe\TestCase
{
    ...
    public function testCreateBalanceTransaction()
    {
        ...
        $this->assertInstanceOf(\Stripe\CustomerBalanceTransaction::class, $resource);
    }
    ...
    public function testDeleteDiscount()
    {
        ...
        $this->assertInstanceOf(\Stripe\Discount::class, $resource);
    }
